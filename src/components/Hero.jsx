      ...
      <div id="infoBars" class="flex gap-3.5 mt-10 p-2.5 flex-col md:flex-row">
        ...
        >
          <div class="flex flex-col items-start space-y-6">
            ...
            <div>
              <h2 class="mb-2 text-xl font-bold text-white">Instant Search</h2>
              <p class="max-w-[320px] text-sm leading-relaxed text-slate-400">
                Type any keyword and get the latest news articles from hundreds
                of global sources in seconds.
              </p>
            </div>
        ...
        >
          <div class="flex flex-col items-start space-y-6">
            ...
            <div>
              <h2 class="mb-2 text-xl font-bold text-white">Powered by N8N</h2>
              <p class="max-w-[320px] text-sm leading-relaxed text-slate-400">
