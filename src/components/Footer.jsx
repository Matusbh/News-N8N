export default function Footer() {
  return (
    <footer className="w-full flex justify-between items-center px-6 py-4 mx-auto bg-[#131318]/70 backdrop-blur-xl border-t rounded-t-xl border-white/10 shadow-[0_0_15px_rgba(124,58,237,0.1)] mt-5">
